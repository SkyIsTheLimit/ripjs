...
var ModelFactoryCreator = function(configuration) {
    ...
    var saveDatabase = function() {
        ...
        instance.db.saveDatabase(function(err) {
            ...
            logger.info('Saved DB', configuration.db.name);
    ...
    /**
     * Function for creating the endpoints. Once the models get processed throught the
     * MFC, they reach this layer, where they are converted to endpoints.
     **/
    var createEndpoints = instance.createEndpoints = function() {
        return endpoints.create(models, configuration);
    };
